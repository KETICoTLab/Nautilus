...
class nt_FedAvg_Pack(nt_FedAvg):
    ...
    def run(self) -> None:
        ...
        contribution_method = 'robust_volume'
        ...
        for self.current_round in range(self.start_round, self.start_round + self.num_rounds):
            ...
            print(f"\nresult_info: {client_result_information}\n")
            if contribution_method != None:
                contrib_results = connect_contrib_evaluation(contribution_method, initial_model, results, DEVICE, testloader, mode=None, weight_list=None)
            ...
            summary_json = {
                ...
                "contrib_results": contrib_results  # 가정: dict or list 형태
            }
